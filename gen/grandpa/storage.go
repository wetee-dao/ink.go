...
// Make a storage key for State id={{false [97]}}
//
...
// Make a storage key for PendingChange id={{false [98]}}
//
...
// Make a storage key for Stalled id={{false [101]}}
//
...
// Make a storage key for Authorities id={{false [99]}}
//
