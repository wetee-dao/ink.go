...
// Make a storage key for LastRuntimeUpgrade id={{false [55]}}
//
...
// Make a storage key for ExecutionPhase id={{false [52]}}
//
...
// Make a storage key for AuthorizedUpgrade id={{false [59]}}
//
