...
// Make a storage key for LastRuntimeUpgrade id={{false [77]}}
//
...
// Make a storage key for ExecutionPhase id={{false [73]}}
//
...
// Make a storage key for AuthorizedUpgrade id={{false [80]}}
//
