...
// Make a storage key for LastRuntimeUpgrade id={{false [560]}}
//
...
// Make a storage key for ExecutionPhase id={{false [558]}}
//
...
// Make a storage key for AuthorizedUpgrade id={{false [563]}}
//
