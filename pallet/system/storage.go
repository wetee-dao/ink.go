...
// Make a storage key for LastRuntimeUpgrade id={{false [51]}}
//
...
// Make a storage key for ExecutionPhase id={{false [48]}}
//
...
// Make a storage key for AuthorizedUpgrade id={{false [55]}}
//
