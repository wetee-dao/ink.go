...
// Make a storage key for InboundXcmpSuspended id={{false [399]}}
//
...
// Make a storage key for OutboundXcmpStatus id={{false [402]}}
//
...
// Make a storage key for QueueConfig id={{false [408]}}
//
