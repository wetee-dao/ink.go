...
// Make a storage key for State id={{false [111]}}
//
...
// Make a storage key for PendingChange id={{false [112]}}
//
...
// Make a storage key for Stalled id={{false [115]}}
//
...
// Make a storage key for Authorities id={{false [113]}}
//
