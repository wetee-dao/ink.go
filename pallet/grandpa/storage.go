...
// Make a storage key for State id={{false [103]}}
//
...
// Make a storage key for PendingChange id={{false [104]}}
//
...
// Make a storage key for Stalled id={{false [107]}}
//
...
// Make a storage key for Authorities id={{false [105]}}
//
