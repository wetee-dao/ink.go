...
// Make a storage key for State id={{false [98]}}
//
...
// Make a storage key for PendingChange id={{false [99]}}
//
...
// Make a storage key for Stalled id={{false [102]}}
//
...
// Make a storage key for Authorities id={{false [100]}}
//
